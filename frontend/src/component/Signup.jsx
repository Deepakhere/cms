    ...
    <div className="register-container">
      <div className="form-container">
        <div className="logo-text">
          <svg width="84" height="84" viewBox="0 0 45 52" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            <input type="text" className="form-control contentclass"
          ...
          <div className="form-group">
            ...
            <input type="email" className="form-control contentclass" id="email"
          ...
          <div className="form-group">
            ...
            <input type="password" className="form-control contentclass" id="password"
          ...
          <div class="form-check">
            <input type="checkbox" class="form-check-input contentclass" id="exampleCheck1" />
            <label class="form-check-label" for="exampleCheck1">Subscribe to our newsletter</label>
          </div>
          <p className='description'>Your personal data will be used to support your experience throughout this website, to manage access to your account, and for other purposes described in our <Link to="">privacy policy.</Link></p>
