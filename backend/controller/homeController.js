...
const homePageData = (req, res) => {
    ...
    try {
        const { title, subtext, bodyContent, url, publishTime, publishDate, checked, isPublished } = req.body;
        ...
        cloudinary.uploader.upload(filePath, async(err,result)=>{
            ...
            .then((user) => {
                ...
                if (user) {
                    ...
                    .then(result => { res.status(201).json("Data Insert Successfully") })
                    .catch(err => {
